...
startName='H:\sulei\轮廓制作\test_05587_montage_edge.tif';
...
imwrite(image_in,'H:\sulei\轮廓制作\test_05587_montage_bw.tif')
...
imshow(outImage);
imwrite(outImage,'H:\sulei\轮廓制作\test_05587_montage_findEdge.tif')
