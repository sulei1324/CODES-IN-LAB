...
for i=1:involvedZNum
    ...
    outImage(:,:)=inImage(yS:yS+cropedHeight-1,xS:xS+cropedWidth-1);
...
%         outImage(y,x)=255;
    ...
    imwrite(tmpImage,[dst num2str(zSerial,'%05d') '-rgb.tif']);    
    disp(['done ' dst num2str(zSerial,'%05d') '-rgb.tif']);
    toc;
end
