...
void Tar::untar(){
    ...
    if(_access(whole_file_name.c_str(), 0) == -1){
        cout<<"Create Folder"<< " "<<whole_file_name<<endl;
        _mkdir(whole_file_name.c_str());
    }    
    if(tar_file.good()){
        tar_file.read(buffer, 512);
        if(is_tar_file(buffer)){
            while(true){
                ...
                if(is_end_of_tar(buffer, tar_file.tellg())){
                    ...
                    if(size_num == 0){
                        ...
                        string this_file_path = whole_file_name + "\\" + this_file_name;
                        ...
                        string name_string(name);
                        cout<<"File: "<<name_string<<endl;
                        string this_file_path = whole_file_name + "\\" + name_string;
