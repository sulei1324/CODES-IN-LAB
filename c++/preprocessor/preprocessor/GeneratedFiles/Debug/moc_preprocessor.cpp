...
**
** Created: Fri Nov 27 15:27:09 2015
...
static const char qt_meta_stringdata_preprocessor[] = {
    "preprocessor\0\0changeButton()\0"
};
...
const QMetaObjectExtraData preprocessor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject preprocessor::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_preprocessor,
      qt_meta_data_preprocessor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &preprocessor::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_preprocessor))
