...
bool TestVtkVolume::Update()
{
    if(isInited){
        ...
        colorTrans->AddRGBPoint(0.0, 0.2, 0.2, 0.2);
        colorTrans->AddRGBPoint(40.0, 0.4, 0.4, 0.4);
        colorTrans->AddRGBPoint(100.0, 0.7, 0.7, 0.7);
        colorTrans->AddRGBPoint(255.0, 1.0, 1.0, 1.0);
        opacTrans = vtk_new(vtkPiecewiseFunction);
        opacTrans->AddPoint(0.0, 0.2);
        opacTrans->AddPoint(255.0, 0.8);
