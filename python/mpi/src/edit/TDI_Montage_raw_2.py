...
import numpy as np
readPre="/lustre/share/Public/mostPreprocess/TDI048_red/src/"
readMid1="test_R__"
readMid2=".jpg"
readPost=".jpg"
writePre="/lustre/share/Public/mostPreprocess/TDI048_red/montage/"
writePost=".tif"
...
xStr="%d"%(xBeg)
yStr="%d"%(yBeg)
filename=readPre+numStr+"/"+"test_R__"+numStr+"_"+xStr+"_"+yStr+readPost
cacheName=tmpDir+"test_R__"+numStr+"_"+xStr+"_"+yStr+readPost
...
for z in xrange(begNum, endNum+1):
	numStr="%05d"%(z)
	print "processing "+"test_R__"+numStr+"python.tif"
